...
class MainActivity : AppCompatActivity() , View.OnClickListener, OnItemLongClickListener{
    ...
    // 필요한 필드 정의하기
    // null 을 대입했다가 나중에 값을 바꾸려면 번거롭다.
    // lateinit 예약어를 활용하면 null 을 넣을 필요 없이 값을 나중에 넣을 수 있다.
    ...
    override fun onClick(v: View?) {
        ...
        inputText.setText("")
        // 8. ListView 의 가장 아래쪽이 화면에 보일 수 있도록 부드럽게 스크롤 시키기
