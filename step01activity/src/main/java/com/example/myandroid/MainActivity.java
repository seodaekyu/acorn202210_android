...
// app 을 실행했을 때 처음 사용자를 대면하는 ManiActivity
...
public class MainActivity extends AppCompatActivity {
    ...
    /*
        activity_main.xml 에 정의한 버튼을 눌렀을때 호출되는 메소드 정의하기
        메소드의 인자로 View type 을 전달받도록 만들어야 한다.
     */
    public void sendClicked(View v){
        // 로그 창에 문자열 출력하기 (System.out.println() 이 아님!!)
    ...
    /*
        ...
        해당 버튼을 눌렀을때 "삭제 버튼을 눌렀네?" 라는 토스트 메시지가 출력되도록 해보세요
     */
    public void DeleteClicked(View v){
        Log.i("나의 tag", "삭제버튼을 눌렀네?");
