...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            ...
            만일, Java code 에서 해당 UI 를 가지고 어떤 동작을 하려면 그 객체의 참조 값이 필요하다
            그 객체의 참조 값을 어떻게 얻어오는지를 학습하기
         */
        // id 를 이용해서 EditText 객체의 참조 값 얻어오기
        this.inputMsg = findViewById(R.id.inputMsg);

        // id 를 이용해서 Button 객체의 참조 값 얻어오기
        Button sendBtn = findViewById(R.id.sendBtn);
        // 버튼을 클릭했을때 호출 될 메소드를 가지고 있는 View.OnClickListener type 의 참조 값 전달하기
        sendBtn.setOnClickListener(this);
        // TextView 의 참조 값 얻어오기
