...
public class PlaceholderFragment extends Fragment {
    ...
    public static PlaceholderFragment newInstance(String ownerName) {
        ...
        // "ownerName" 이라는 키 값으로 전달된 이름을 담고
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Bundle 객체에 "ownerName" 이라는 키 값으로 담겨 있는 이름을 얻어낸다.
    ...
    public View onCreateView(
        ...
        // fragment_main.xml 문서를 전개해서 만든 View 의 참조 값
        View root = binding.getRoot();
        // TextView 의 참조 값을 얻어와서
        final TextView textView = binding.sectionLabel;
        // PageView 모델이 갖고 있는 데이터를 관찰하다 변경이 되면 UI 를 업데이트할 옵저버 등록
        // 단, View 의 주인이(Fragment or Activity) 활성화된 상태에서만 동작하겠다는 의미
